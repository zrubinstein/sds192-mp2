...
####It is interesting to look at the congressional districts that voted for a given party. Given that PA is in the northeast, and cities in the northeast generally tend to be liberal, we were surprised that in many of the congressional districts surrounding Philadelphia, the capital, the house candidate that was elected was republican. 
